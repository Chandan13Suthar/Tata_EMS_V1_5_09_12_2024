...
public class RuntimeNetLogic2 : BaseNetLogic
{
    ...
    public override void Start()
    {
        ...
        apparentpowerutilityVariable = owner.UtilityApparentPowerTotalVariable;
        // Stamping
        ...
        apparentpowerstampingVariable = owner.StampingApparentPowerTotalVariable;
        ...
        apparentpowertcfVariable = owner.TCFApparentPowerTotalVariable;
        ...
        apparentpowerbodyshopVariable = owner.BodyShopApparentPowerTotalVariable;
        ...
        apparentpoweradminVariable = owner.AdminApparentPowerTotalVariable;
        ...
        apparentpowerpaintshopVariable = owner.PaintshopApparentPowerTotalVariable;
        ...
        apparentpowersppVariable = owner.SppApparentPowerTotalVariable;
        ...
        apparentpower33kvVariable = owner.KV33ApparentPowerTotalVariable;
    ...
    public void IncrementDecrementTask()
    {
        try
        {
            ...
            float apparentutility = apparentpowerutilityVariable.Value;
            ...
            float apparentstamping = apparentpowerstampingVariable.Value;
            // For TCF
            ...
            float apparenttcf = apparentpowertcfVariable.Value;
            ...
            float apparentbodyshop = apparentpowerbodyshopVariable.Value;
            ...
            float apparentadmin = apparentpoweradminVariable.Value;
            ...
            float apparentpantshop = apparentpowerpaintshopVariable.Value;
            ...
            float apparentspp = apparentpowersppVariable.Value;
            ...
            float apparent33kv = apparentpower33kvVariable.Value;
            ...
            myStore.Query("SELECT Apparent_Energy_Total FROM DailyJaceDataLogger WHERE Timestamp = '" + date2 + " 00:00:00.000' AND Jace = 'UTILITY' ", out string[] header6, out object[,] resultSet6);
            // For Stamping
            ...
            myStore.Query("SELECT Apparent_Energy_Total FROM DailyJaceDataLogger WHERE Timestamp = '" + date2 + " 00:00:00.000' AND Jace = 'STAMPING' ", out string[] header11, out object[,] resultSet11);
            // For Tcf
            ...
            myStore.Query("SELECT Apparent_Energy_Total FROM DailyJaceDataLogger WHERE Timestamp = '" + date2 + " 00:00:00.000' AND Jace = 'TCF' ", out string[] header16, out object[,] resultSet16);
            ...
            myStore.Query("SELECT Apparent_Energy_Total FROM DailyJaceDataLogger WHERE Timestamp = '" + date2 + " 00:00:00.000' AND Jace = 'BODYSHOP' ", out string[] header21, out object[,] resultSet21);
            ...
            myStore.Query("SELECT Apparent_Energy_Total FROM DailyJaceDataLogger WHERE Timestamp = '" + date2 + " 00:00:00.000' AND Jace = 'ADMIN' ", out string[] header26, out object[,] resultSet26);
            // For Paintshop
            ...
            myStore.Query("SELECT Apparent_Energy_Total FROM DailyJaceDataLogger WHERE Timestamp = '" + date2 + " 00:00:00.000' AND Jace = 'PAINTSHOP' ", out string[] header31, out object[,] resultSet31);
            ...
            myStore.Query("SELECT Apparent_Energy_Total FROM DailyJaceDataLogger WHERE Timestamp = '" + date2 + " 00:00:00.000' AND Jace = 'SPP' ", out string[] header36, out object[,] resultSet36);
            ...
            //myStore.Query("SELECT Apparent_Energy_Total FROM DailyJaceDataLogger WHERE Timestamp = '" + date2 + " 00:00:00.000' AND Jace = 'UTILITY' ", out string[] header41, out object[,] resultSet41);
            ...
            myStore.Query("SELECT Apparent_Energy_Total FROM DailyJaceDataLogger WHERE Timestamp = '" + date2 + " 00:00:00.000' AND Jace = '33KV' ", out string[] header46, out object[,] resultSet46);
            ...
            */
            ...
            if (rowCount6 > 0 && columnCount6 > 0)
            {
                ...
                var UtilityApparentPowerTotal = column1;
                apparentutility = UtilityApparentPowerTotal;
            }
            //Stamping
            ...
            if (rowCount11 > 0 && columnCount11 > 0)
            {
                ...
                var StampingApparentPowerTotal = column1;
                apparentstamping = StampingApparentPowerTotal;
            }
            ...
            if (rowCount16 > 0 && columnCount16 > 0)
            {
                ...
                var TCFApparentPowerTotal = column1;
                apparenttcf = TCFApparentPowerTotal;
            }
            ...
            if (rowCount21 > 0 && columnCount21 > 0)
            {
                ...
                var BodyShopApparentPowerTotal = column1;
                apparentbodyshop = BodyShopApparentPowerTotal;
            }
            ...
            if (rowCount26 > 0 && columnCount26 > 0)
            {
                ...
                var AdminApparentPowerTotal = column1;
                apparentadmin = AdminApparentPowerTotal;
            }
            ...
            if (rowCount31 > 0 && columnCount31 > 0)
            {
                ...
                var PaintshopApparentPowerTotal = column1;
                apparentpantshop = PaintshopApparentPowerTotal;
            }
            ...
            if (rowCount36 > 0 && columnCount36 > 0)
            {
                ...
                var SppApparentPowerTotal = column1;
                apparentspp = SppApparentPowerTotal;
            }
            ...
            */
            ...
            var rowCount46 = resultSet46 != null ? resultSet46.GetLength(0) : 0;
            var columnCount46 = header46 != null ? header46.Length : 0;
            if (rowCount46 > 0 && columnCount46 > 0)
            {
                var column1 = Convert.ToInt32(resultSet46[0, 0]);
                var KV33ApparentPowerTotal = column1;
                apparent33kv = KV33ApparentPowerTotal;
            }
            ...
            apparentpowerutilityVariable.Value = apparentutility;
            ...
            apparentpowerstampingVariable.Value = apparentstamping;
            ...
            apparentpowertcfVariable.Value = apparenttcf;
            ...
            apparentpowerbodyshopVariable.Value = apparentbodyshop;
            ...
            apparentpoweradminVariable.Value = apparentadmin;
            ...
            apparentpowerpaintshopVariable.Value = apparentpantshop;
            ...
            apparentpowersppVariable.Value = apparentspp;
            ...
            apparentpower33kvVariable.Value = apparent33kv;
    ...
    private IUAVariable apparentpowerutilityVariable;
    ...
    private IUAVariable apparentpowerstampingVariable;
    ...
    private IUAVariable apparentpowertcfVariable;
    ...
    private IUAVariable apparentpowerbodyshopVariable;
    private IUAVariable consumptionpaintshopVariable;
    private IUAVariable apparentpowerpaintshopVariable;
    ...
    private IUAVariable apparentpowersppVariable;
    ...
    private IUAVariable apparentpower33kvVariable;
    ...
    private IUAVariable apparentpoweradminVariable;
