...
public class MonthGenericTableExporter : BaseNetLogic
{
    [ExportMethod]
    public void Export()
    {
        try
        {
            ...
            {
                var Jace = Project.Current.GetVariable("Model/Reports/JaceNameMonthReport").Value;
                var Meter = Project.Current.GetVariable("Model/Reports/MeterNameMonthReport").Value;
                var Datefrom = Project.Current.GetVariable("Model/Reports/Second_Report_Links/ReportMonthName").Value;
               // var Dateto = Project.Current.GetVariable("Model/Reports/Daily Date To").Value;
                ...
                csvWriter.WriteLine(new string[] { "Month Consumption Report" });
                ...
                csvWriter.WriteLine(new string[] { $"Month: {datefrom}"});
                csvWriter.WriteLine(new string[] { "" }); // Empty line for spacing
